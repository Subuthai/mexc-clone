...
const noticeData = [
    ...
    {
        title: '[İlk Listeleme] MEXC, WUKONG (WUKONG) Projesini Değerlendirme Bölgesinde Listeleyecek',
        link: '#' ,
    },
    {
        title: 'MEXC CATDOG, NEIRO, SUNWUKONG, SUNCAT, CVP, TRUMP, BCCOIN, MAGA, NPC, VISTA ve LRDS USDT-M Vadeli İşlemleri Alım Satım Hizmetini Yeniden Başlattı (7 Eylül)',
        link: '#' ,
    },
    {
        title: 'MEXC USDT Spot Piyasası için Sistem Yükseltmesini Tamamladı (7 Eylül)',
        link: '#' ,
    },
    {
    ...
    {
        title: 'MEXC, NEIROETH USDT-M Vadeli İşlemleri Fonlama Oranı Uzlaşma Sıklığı Düzenlemesi (6 Eylül)',
        link: '#' ,
    },
    {
    ...
    {
        title: '[İlk Listeleme] MEXC Kickstarter - LOL (LOL) Projesi için Oy Kullanın, 362.500 LOL Airdrop Kazanın!',
        link: '#' ,
    },
    {
        title: 'MEXC, SNT USDT-M Vadeli İşlemlerinin Maksimum Kaldıraç Çarpanını Düşürecek (6 Eylül)',
        link: '#' ,
    },
    {
        title: 'MEXC, QUICK USDT-M Vadeli İşlemleri Fonlama Oranı Uzlaşma Sıklığı Düzenlemesi (6 Eylül)',
        link: '#' ,
    },
    {
    ...
    {
        title: 'MEXC İşlem Kopyalama, QUICK USDT-M Vadeli İşlemlerini Destekleyecek',
        link: '#' ,
    },
    {
    ...
    {
        title: 'MEXC Vadeli İşlemler "15-200x Vadeli Kaldıraç Yarışması" Başlıyor - BIGTIME, APE, ADA, FLOKI, SAGA, APT, BSW ve DOGE USDT-M Sürekli Vadeli İşlemi Yaparak 20.000 USDT Bonus Kazanın! (6 - 11 Eylül)',
        link: '#' ,
    },
    {
...
export default function Homepage() {
        ...
        <>
            <div className="banner-bottom-bar_bottomBar__IuLsX banner-bottom-bar_isScrollStop__j6DKa" ref={elementRef}>
                <div className="banner-bottom-bar_barInfo__bCyyu"
                     onClick={() => window.location.href = 'http://localhost:5173/exchange'}>
                ...
                <div className="banner-bottom-bar_barInfo__bCyyu"
                     onClick={() => window.location.href = 'http://localhost:5173/wallet'}>
                    <svg className="sc-gEvEer hSTeNi mx-icon" focusable="false" width="1em" height="1em"
            ...
            <div className='banner-wrapper'>
                <div className='banner-img-wrapper'>
                    ...
                    <div className="video-player_video-player-content__Kmbbl">
                                <video src="/public/background-home.mp4" ref={myvideo}
                        ...
                        <div className='banner-content'>
                            <div className='banner-content-box'>
                                <div className='banner-content-box__title'>
                                    <h1>En Fazla Token Sayısı<br/>En Düşük İşlem Ücretleri</h1>
                                </div>
                                <p className='banner-content-box__desc'>Piyasa Yapıcı <strong>0%</strong>
                                    <br/>Piyasa Alıcı <strong>%0,01-%0,02</strong></p>
                            </div>
                            ...
                            { !isLoggedIn && ( 
                                ...
                                <Popover className='banner-content-action__btn social-btn social-btn-qr'
                                         ...
                                         content={(
                                             <div>
                                                 <p className="banner-content-action-btn__title">Uygulamayı indirmek için tarayın</p>
                                                 <div className='qr-img'>
                                                     <img src="./qr-1.png" alt=""/>
                                                 </div>
                                             </div>
                                         )}>
                                    <Button icon={<svg focusable="true" width="1em" height="1em"
  ...
  <div className="bonus-card">
    <div className="bonus-icon">
      <img src="https://static.mocortech.com/www/static/images/new-home/mobility/mobility_bouns.png" alt="Bonus Icon 1" />
    </div>
  ...
  <div className="bonus-card">
    <div className="bonus-icon">
      <img src="https://static.mocortech.com/www/static/images/new-home/mobility/mobility_upcoin.png" alt="Bonus Icon 2" />
    </div>
    <div className="bonus-content">
  ...
  <div className="bonus-card">
    <div className="bonus-icon">
      <img src="https://static.mocortech.com/www/static/images/new-home/mobility/mobility_mx.png" alt="Bonus Icon 3" />
    </div>
    <div className="bonus-content">
      ...
      <p>Günlük Token Hediyesi, APY %66,50</p>
            ...
            <div className="why-choose-mexc_why-choose-wrapper__ud1w8">
                <div className="why-choose-mexc_why-choose__SUZms home-container"><h2>Neden MEXC?</h2>
                    <div className="why-choose-container">
                        <div className="video-player_video-player__e0dtZ">
                            <div className="video-player_video-player-content__Kmbbl">
                                <video src="https://learn.mocortech.com/learnvideo/Frontpage-Video-TR.mp4" ref={myvideo}
                                       muted preload="auto" loop>
                                </video>
                            </div>
                            <div className="video-player_specs-tab__lYN2b">
                                <div className="video-player_specs-tab-content__61jqd" data-theme="dark">
                                    <div className="video-player_specs-tab-item__sIc2t">
                                        ...
                                        <label>Piyasadaki En Uygun İşlem Ücreti</label></div>
                                    <div className="video-player_specs-tab-item__sIc2t">
                                        ...
                                        <label>Piyasadaki En İyi Likidite Oranı</label></div>
                                    <div
                                        ...
                                        <label>Dünya Standartlarında Güvenlik Sistemi</label></div>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div className="products_productsContWrap__4ogse home-container">
                ...
                <ul className="products_productsCont__QZKeW">
                    <li>
                        <div className="products_webCont__QX7YI"><img
                            ...
                            height="200"/>
                            <div className="products_rightPart__zRAWS"><h3>Vadeli İşlemler</h3><p>No. 1 Likidite, Yapıcı Ücreti.</p>
                                <p className="products_des__CFIiD">Yeni ve yüksek kaliteli kripto projelerini iyi likidite ile verimli bir şekilde başlatıyoruz.</p>
                                <aside>
                    ...
                    <li>
                        <div className="products_webCont__QX7YI"><img src="./product-spot_2x.png"
                                                                      ...
                                                                      height="200"/>
                            <div className="products_rightPart__zRAWS"><h3>Spot</h3><p>Yüzlerce Token, Hızlı Listeleme</p>
                                <p className="products_des__CFIiD">Birinci sınıf borsalar arasında listelenen kripto para miktarı bakımından en üst sıralardayız.</p>
                                <aside>
                                    <button type="button" className="ant-btn ant-btn-text products_productsLink__7krbH">
                                        <span>Daha Fazla Bilgi</span>
                                        <svg className="sc-gEvEer hSTeNi mx-icon" focusable="false" width="1em"
                ...
                <div className="products_loginBtn__rFbKX">
                    <Button onClick={()=>{window.location.href='http://localhost:5173/login'}} type="primary" className='section-main-btn '>Al - Sat Yapmaya Başla</Button>
                </div>
            </div>
            <div className="community_community__EJdFT">
                ...
                <div className="community_community-body__Jgr43 home-container"><h2>Hemen MEXC Topluluğuna Katılın</h2>
                    <p>Daima yanınızda</p>
                    ...
                    <div className="download_downloadInfoWrapper__9S0v_">
                        <div className="download_downloadInfoGroup__ITmEa">
                            <div className="download_downloadInfo__WX6Ki"><img
                                ...
                                <div className="download_contRight___VlGG"><h5>Portföyünüzü Kolayca Yönetin</h5>
                                    <p>Güçlü özellikler, yüksek yürütme hızı ve düşük ücretlerle tek noktadan hizmet platformumuz aracılığıyla profesyonel bir yatırımcı olun.</p></div>
                            </div>
                            <div className="download_downloadInfo__WX6Ki"><img
                                src="./mobile_apps.svg?v=1001" alt="mexc" loading="lazy"/>
                                <div className="download_contRight___VlGG"><h5>Çoklu Platform Uygulama Desteği</h5>
                                    <p>MEXC Uygulaması ile tüm favori tokenlarınızı zahmetsizce, her zaman ve her yerde satın alın ve takas edin.</p></div>
                            </div>
                        </div>
            ...
            <div className="sidebar_wrapper__LNgtQ sidebar_floatWrapper__SOb5e" ref={contacRef}>
                <Tooltip placement="top" title={(<div>{pinTab ? "Gizle" : "Sabitle"}</div>)}>
                ...
                <Tooltip placement="top" title={(<div>Talep Oluştur</div>)}>
                    <a className="sidebar_btn__5nhuP" href="#"
                       rel="nofollow noopener noreferrer">
