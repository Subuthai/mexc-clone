...
const menuItemsData = [
    {
        title: "Piyasa",
        url: "http://localhost:5173/exchange",
    },
    {
        title: "Spot",
        url: "/exchange",
    ...
    useEffect(() => {
      ...
      const handleLogout = async () => {
        try {
          ...
          await window.location.replace('http://localhost:5173/login');
        } catch (error) {
        ...
        <>
                                ...
                                <div className='language-list'>
                                    {languageData.map((item, index) => {
                                        return (<div key={index}
                                                     className={`language-item ${item.id === 6 ? 'active' : ''}`}
            ...
            <AntdHeader className='header-nav'>
                <div className={`mobile-header-nav ${isShowSideBar ? 'showSidebar' : ''}`} ref={sideBarRef}>
                    <div className="header_mobileMenuWrapper__tHt0l">
                        ...
                        { !isLoggedIn && ( 
                            <div className="header_headerLeft__RZb3I">
                                <div className="header_navItem__dEqAQ header_authBtn__Gch60 header_navItem__dEqAQ">
                                    <a href='http://localhost:5173/login'
                                       className="header_registerBtn__fsUiv header_authBtn__Gch60">Giriş Yap/Kayıt Ol</a>
                                </div>
                            </div>
                        )}
                                    ...
                                    if(item.submenu){
                                        return ( <div key={index} className="header_innerMenu__SAvVj">
                                            <div className="header_innerMenuBtn__gCP9O header_mobileMenuBtn__KBVfi" onClick={()=>handleShowMenuSideBar(index)}>
                                                <span>{item.title} {item.status === 'hot' &&  <span className='icon-hot'>Öne Çıkan</span>}</span>
                                                <svg
                                                                    ...
                                                                    <div className="header_itemBody__U65v7">
                                                                        <div className="header_itemTitle__jicUg">
                                                                            <span onClick={()=> {
                                                                                ...
                                                                                {item.status === 'hot' &&  <span className='icon-hot'>Öne Çıkan</span>}</span>
                                                                            {item.submenu &&
                                                                                <svg onClick={()=>{
                                                                                    handleShowDrawContent(item.submenu)
                            ...
                            <div><a className="header_mobileMenuBtn__KBVfi" href="#"><span>Uygulamayı İndir</span>
                                ...
                                <div className="header_mobileMenuBtn__KBVfi" onClick={handleSetActiveTabLanguage}><span>TR</span>
                                    <svg className="sc-aXZVg ktFCMi mx-icon" focusable="false" width="1em" height="1em"
                                         fill="currentColor" aria-hidden="true" viewBox="0 0 1024 1024"
                                         data-icon="RightOutlined">
                                        <path
                                ...
                                <div className="header_hostComponent__gMit0">
                                    <div className="header_mobileMenuBtn__KBVfi"><span>Karanlık Mod</span>
                                        <div><Switch onClick={toggleDarkMode} checked={isDarkMode}/></div>
                                    </div>
                                </div>
                                <div className="header_hostComponent__gMit0">
                                    <div className="header_mobileMenuBtn__KBVfi">
                                    <Button className="mobile-logout-btn" onClick={handleLogout}>Çıkış Yap</Button>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div style={leftMenuStyle} className='desktop-nav'>
                    <div className="logo" style={logoWrapperStyle} onClick={() => {
                        ...
                        {menuItemsData.map((item, index) => {
                            return (<li key={index} className='navbar-list-item'>
                                <a className='navbar-list-item__link' href={item.url}>{item.title} {item.img && <img className='header_navItemCustomIconTag' src={item.img} alt="img" />}
                                    {item.status === 'hot' && <span className='hot-tag'>Öne Çıkan</span>}
                                        ...
                                        return(
                                            <li key={index} className="menu-item">
                                                ...
                                                <span><a className=""
                                                    ...
                                                    <div className="header_itemTitle__jicUg">
                                                    <span>{item.title} {item.status === 'hot' &&  <span className='icon-hot'>Öne Çıkan</span>}
                                                        {item.status === 'new' &&
                                                            <i className='new-icon'>Yeni</i>}
                                                    </span></div>
                                                    <div
                ...
                <div style={rightMenuStyle} className='right-menu'>
                    ...
                    { isLoggedIn && ( 
                    <div className="user-icon-container" onClick={() => {
                        window.location.href = 'http://localhost:5173/user';
                      }}>
                        <svg focusable="false" width="1em" height="1em" fill="currentColor" aria-hidden="true" viewBox="0 0 24 24" data-icon="UserOutlined" style={{ fontSize: '20px' }}>
                         <path fillRule="evenodd" clipRule="evenodd" d="M12 8C13.1046 8 14 7.10457 14 6C14 4.89543 13.1046 4 12 4C10.8954 4 10 4.89543 10 6C10 7.10457 10.8954 8 12 8ZM12 10C14.2091 10 16 8.20914 16 6C16 3.79086 14.2091 2 12 2C9.79086 2 8 3.79086 8 6C8 8.20914 9.79086 10 12 10ZM8 14C6.34315 14 5 15.3431 5 17V19H19V17C19 15.3431 17.6569 14 16 14H8ZM3 17C3 14.2386 5.23858 12 8 12H16C18.7614 12 21 14.2386 21 17V19C21 20.1046 20.1046 21 19 21H5C3.89543 21 3 20.1046 3 19V17Z"></path>
                        </svg>
                    </div>
                    )}
                    { isLoggedIn && ( 
                                    ...
                                    <div className='download-dropdown-wrapper'>
                                        <div className='download-dropdown__body'>
                                            ...
                                            <div className='download-dropdown__info'>
                                                ...
                                                <div className='download-dropdown__desc'>Benzersiz Bir Alım Satım Deneyiminin Tadını Çıkarmak için MEXC Uygulamasını Hemen İndirin
                                                </div>
                                        ...
                                        <div className='download-dropdown__footer'>
                                            <span className='download-dropdown__title-verson'>Windows İstemcisi</span>
